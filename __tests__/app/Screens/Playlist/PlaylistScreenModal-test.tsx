...
import PlaylistModal from '../../../../app/screens/Playlist/PlaylistModal';
...
describe("group tesing goes here", () => {
    test('delete song', () => {
        ...
        const { getByTestId } = render(<PlaylistModal />);
    ...
    //     const { getByTestId } = render(<PlaylistModal setSong={() => { }} playlistRef={playlistReference} />);
